...
const Mentor = () => {
  return (
    <div className="container mx-auto my-[72px] px-4">
      <div className="xl:mb-[80px] md:mb-14 mb-10 text-center text-grey">
        <h2 className="mb-2 xl:text-[40px] lg:text-4xl text-3xl font-medium">Meet Our Top Mentors</h2>
        <p className="xl:text-xl md:text-lg text-base  font-normal">
