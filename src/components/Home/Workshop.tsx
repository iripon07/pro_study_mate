  ...
  return (
    <div className="bg-whiteSmoke">
      <div className="container mx-auto py-9 px-4">
        <div className="xl:mb-[110px] md:mb-10 mb-6  text-center">
          <h2 className="xl:text-[40px] md:text-3xl text-2xl font-medium text-[#1E1E1E]">
            Latest Workshop
          </h2>
          <p className="xl:text-xl md:text-lg text-base font-normal text-[#4B5155BF]">
