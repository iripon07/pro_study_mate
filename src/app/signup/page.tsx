      ...
      <div style={{ border: "1px solid red" }} className="container mx-auto">
        ...
        >
          ...
          >
            ...
            <div
              className="flex w-full items-center rounded bg-blue text-base font-semibold text-white"
            >
              <div
                className="ml-3 mr-6 rounded-2xl bg-white px-[9px] py-[4px]"
              >
